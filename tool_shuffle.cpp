...
int main(int argc, char* argv[]) {
    ...
    std::string output_dir = std::string(".\\corpora\\") + from_code + "-" + to_code + "\\";
    if (!std::filesystem::exists(output_dir)) {
        std::filesystem::create_directories(output_dir);
    }
    std::string source_train = output_dir + from_code + ".train.corpus";
    std::string target_train = output_dir + to_code + ".train.corpus";
    std::string source_valid = output_dir + from_code + ".valid.corpus";
    std::string target_valid = output_dir + to_code + ".valid.corpus";
